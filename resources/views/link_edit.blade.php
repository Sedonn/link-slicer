          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <img class="img-profile rounded-circle" src="https://lh3.googleusercontent.com/proxy/-9rH5WPB6NH2vXv7iLzuSQw9wfxntyBFBTFEt9QNwFRSon0eEXiW1Ojokq3_jaA4RRMJfIKnFAtEi7yZ3zjyyNPqi1ZfPKvgbgFAOYaYWAQ">
              </a>
                  ...
                  @section('user_links_data')
                    @if($userLinks->count() > 0)
                      @foreach ($userLinks as $userLink)
                        <tr>
                          <td width="10px"><input type="radio" name="userLink" value="{{ $userLink->link }}"></td>
